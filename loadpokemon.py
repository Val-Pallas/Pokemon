...
if combat.winfo_exists():
    # create label widget here
    title_label = tk.Label(combat, text="Good Game!")
title_label.pack()
...
my_pokemon = {
    "name": pokemon.name,
    "id": pokemon.dex,
    "types": [t for t in pokemon.types]
}
def print_name():
    print(my_pokemon["name"])

btn_name = tk.Button(combat, text="Print Name", command=print_name)
btn_name.pack()
